...
export default async function AdminPage() {
  ...
  return <AdminClient categories={categories} settings={settings} aboutPage={aboutPage!} stats={stats} userName={admin.displayName} signOutPath={process.env.NODE_ENV === "development" ? "/api/admin/logout" : chatGPTSignOutPath("/")} />;
}
