...
export default function AdminSpacesPanel({initialSpaceId=null,createOnOpen=false,onCreateArticle,onEditArticle,onBrowseArticle}:{initialSpaceId?:number|null;createOnOpen?:boolean;onCreateArticle:(spaceId:number,spacePath:string)=>void;onEditArticle:(postId:number)=>void;onBrowseArticle:(postId:number)=>void}){
