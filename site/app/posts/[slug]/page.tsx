...
export default async function LegacyPostPage({ params, searchParams }: { params:Promise<{ slug:string }>; searchParams:PageSearchParams }) {
  ...
  if (adminPreview) {
    ...
    const post = stored ?? { id:-1, publicId:"preview", title:"未命名文章", slug:"preview", excerpt:"文章摘要会显示在这里。", content:"从后台开始写作，正文会在这里实时呈现。", categoryName:"未分类", categorySlug:"uncategorized", categoryColor:"#0071e3", publishedAt:null, viewCount:0 };
