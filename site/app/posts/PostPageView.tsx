  ...
  return <main className="post-page">
    ...
    <section className="post-end">
      ...
      <div className="post-neighbors">
        {previousPost ? <Link className="post-neighbor previous" href={postPath(previousPost)} style={{ "--neighbor-color":previousPost.categoryColor ?? "#0071e3" } as CSSProperties}>
        ...
        {nextPost ? <Link className="post-neighbor next" href={postPath(nextPost)} style={{ "--neighbor-color":nextPost.categoryColor ?? "#0071e3" } as CSSProperties}>
